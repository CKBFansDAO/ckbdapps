...
export default function Home({ onDappSelect }) {
    ...
    }, [current, next]); // 依赖 current 和 next 确保定时器在 current 变化时重新设置

    // Spark Granted Projects 滑动窗口分页
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-40 h-40 flex items-center justify-center">
              <div className="relative w-full h-full">
                ...
                <div className="absolute inset-4 bg-white rounded-full flex items-center justify-center border border-cosmic-purple/30 shadow-lg">
                  <h1 className="font-future text-4xl text-cosmic-purple animate-glow">{banners[current].logo}</h1>
                </div>
              </div>
            </div>
            {/* 标题和描述 */}
                          ...
                          project.placeholder ? (
                            <div key={`${pageIdx}-${idx}`} className="bg-cosmic-lightGray/50 rounded-xl border border-dashed border-cosmic-purple/30 h-[280px] flex items-center justify-center">
                              <div className="text-center p-6">
                                ...
                                <p className="text-cosmic-gray font-tech">{project.name}</p>
                              </div>
                            </div>
                          ) : (
                            <div
                              ...
                              <div className="bg-white rounded-xl overflow-hidden border border-cosmic-purple/20 hover:border-cosmic-purple/50 transition-all duration-300 h-[280px] shadow-lg">
                                ...
                                <div className="p-4">
                                  ...
                                  <div className="flex justify-between items-center mt-3">
                                    <p className="text-sm text-cosmic-gray font-tech">{project.desc}</p>
                  ...
                  >
                    <div className={
                      idx % 2 === 1
                        ...
                        : 'grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-6 bg-white rounded-xl overflow-hidden border border-cosmic-purple/20 hover:border-cosmic-purple/50 transition-all duration-300 shadow-lg'
                    }>
                      ...
                      <div className="p-6 md:p-8 flex flex-col justify-center">
                        <div className="flex items-center gap-3 mb-4">
                          <div className="h-20 w-20 rounded-lg bg-cosmic-purple/10 flex items-center justify-center border border-cosmic-purple/30 overflow-hidden mr-4">
                            <img
